            ...
            <div class="full">
              <div class="center-desk">
                <div class="logo">
                  ...
                  <p class="fs-3 text-white ps-5 mt-1 ">Santiago</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <nav class="navigation navbar navbar-expand-md navbar-dark">
              ...
              <div class="collapse navbar-collapse" id="navbarsExample04">
                <ul class="navbar-nav gap-0">
                  <li class="nav-item">
                    <a class="nav-link" href="./indexv.php">Viña</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="container-fluid">
        <div class="user_login d-flex justify-content-end align-items-center">
          ...
          <?php if (isset($_SESSION['nombres'])) { ?>
            <a href="cerrar_sesion.php" class="btn ms-3 text-white px-4" style="background-color: none; border: 2px solid #fff; border-radius: 30px; font-weight: bold;">Cerrar sesión</a>
          <?php } ?>
        </div>
      </div>
  ...
  <section class="banner_main ">
    <div class="container mt-1 pt-5">
      <div class="row mt-2 pt-5">
        <div class="col-md-12">
          <div class="text-bg">
            <div class="padding_lert mt-5 pt-5">
              <h1>BIENVENIDO A HOTEL VERANUM SANTIAGO</h1>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="choose_box">
            ...
            <a class="read_more" href="./habitaciones.php">Ver más</a>
          </div>
        </div>
        <div class="col-md-6">
          <div class="row">
